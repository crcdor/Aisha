...
public class TouchCameraControl : MonoBehaviour 
{
	...
	void Start () 
	{
		...
		startCameraPosition.x = 0;
		startCameraPosition.y = 0;
	...
	void LateUpdate ()
	{
		...
		if (limitedCameraPosition.y >= -57 && limitedCameraPosition.y <= -55 && limitedCameraPosition.x >= 198 && limitedCameraPosition.x <= 202) {
			minX = 198f;
			maxX = 202f;
			minY = -57f;
			maxY = -55f;
